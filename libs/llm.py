...
llm = ChatOpenAI(model="gpt-4.1-2025-04-14", api_key=api_key, temperature=0.2)
...
if bool(os.getenv("USE_CHEAP_LLM_ONLY")):
    ...
    llmReasoning = ChatOpenAI(model="gpt-4.1-mini", api_key=api_key)
    llmReasoningCheap = ChatOpenAI(model="gpt-4.1-mini", api_key=api_key)
